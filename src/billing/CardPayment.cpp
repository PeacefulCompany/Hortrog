...
CardPayment::CardPayment(float amount, const string& nameOnCard, const std::string& expirationDate, const std::string& creditCardNumber) : Payment(amount), nameOnCard(nameOnCard), expirationDate(expirationDate), creditCardNumber(creditCardNumber) {}

...
std::string KitchenStaff::getRole() const
{
    return role;
}

int KitchenStaff::getLevel() const
{
    return level;
}

KitchenStaff* KitchenStaff::getNext() const
{
    return next;
}

void KitchenStaff::setName(std::string name)
{
    this->name = name;
}

void KitchenStaff::setRole(std::string role)
{
    this->role = role;
}

void KitchenStaff::setLevel(int level)
{
    this->level = level;
}

void KitchenStaff::setNext(KitchenStaff* next)
{
    this->next = next;
}

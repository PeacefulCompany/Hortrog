...
/**
 * @brief The Pescetarian class represents a pescetarian Decortator for an
 * order.
 */
...
public:
     ...
     */
    Pescetarian(std::unique_ptr<Order> order);
...
private:
    const std::string spesification =
        "Pescetarian";         /**< The specification of the modifier. */
